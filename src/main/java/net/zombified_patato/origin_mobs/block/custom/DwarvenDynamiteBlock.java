package net.zombified_patato.origin_mobs.block.custom;
...
public class DwarvenDynamiteBlock extends TntBlock {
    ...
    public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean notify) {
        ...
        if (world.isReceivingRedstonePower(pos)) {
            DwarvenDynamiteBlock.primeTnt(world, pos);
    ...
    public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
        ...
        DwarvenDynamiteEntity tntEntity = new DwarvenDynamiteEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, explosion.getCausingEntity());
    ...
    public static void primeTnt(World world, BlockPos pos) {
        DwarvenDynamiteBlock.primeTnt(world, pos, null);
    }
    ...
    private static void primeTnt(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        ...
        DwarvenDynamiteEntity tntEntity = new DwarvenDynamiteEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, igniter);
        world.spawnEntity(tntEntity);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player2, Hand hand, BlockHitResult hit) {
        ...
        if (itemStack.isOf(Items.FLINT_AND_STEEL) || itemStack.isOf(Items.FIRE_CHARGE)) {
            DwarvenDynamiteBlock.primeTnt(world, pos, player2);
    ...
    public void onProjectileHit(World world, BlockState state, BlockHitResult hit, ProjectileEntity projectile) {
        if (!world.isClient) {
            ...
            if (projectile.isOnFire() && projectile.canModifyAt(world, blockPos)) {
                DwarvenDynamiteBlock.primeTnt(world, blockPos, entity instanceof LivingEntity ? (LivingEntity)entity : null);
